...
import { getDatabase, ref, set, get, update, remove, push } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-database.js";

// Konfigurasi Firebase Anda (sudah lengkap dengan databaseURL)
...
export { database, ref, set, get, update, remove, push };